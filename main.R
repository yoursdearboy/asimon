library(clinfun)
dyn.load('cmake-build-release/asimon')

g <- function(s1, r1, n1, s, m, r, n, p) {
    .Call('g_facade', s1, r1, n1, s, m, r, n, p)
}

en <- function(s1, r1, n1, m2, n2, p) {
    .Call('en_facade', s1, r1, n1, m2, n2, p)
}

asimon_calculate <- function(n1, n2, a_max, b1_max, b2_max, p0, p1, p2) {
    .Call('asimon_facade', n1, n2, a_max, b1_max, b2_max, p0, p1, p2)
}

asimon <- function(a_max, b1_max, b2_max, p0, p1, p2) {
    simon.n1 <- ph2simon(p0, p1, a_max, b1_max)
    simon.n2 <- ph2simon(p0, p2, a_max, b2_max)
